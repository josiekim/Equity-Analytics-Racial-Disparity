...
pov_data_summarized <- pov_long_data %>%
  group_by(Region, race) %>%
  summarize(average_pov_rate = mean(poverty_rate...79, na.rm = TRUE))
...
```
```{r}
plot(SE_lm_model, which = 3, col = "lightblue", pch = 19)
...
plot(ED_lm_model, which = 1, col = "lightpink", pch = 19)
abline(h = 0, col = "black")  # Add a horizontal line at y = 0

# Normal Q-Q Plot
plot(ED_lm_model, which = 2, col = "green", pch = 19, main = "Normal Q-Q Plot")
abline(0, 1, col = "red")  # Add a diagonal line

# Scale-Location (Square Root of Residuals) vs. Fitted Values Plot
plot(ED_lm_model, which = 3, col = "purple", pch = 19, main = "Scale-Location Plot", xlab = "Fitted Values", ylab = "Square Root of Residuals")
abline(h = 0, col = "red")  # Add a horizontal line at y = 0

# Cook's Distance Plot
plot(ED_lm_model, which = 4, col = "orange", pch = 19, main = "Cook's Distance Plot", xlab = "Observation Number", ylab = "Cook's Distance")
...
hist_res <- hist(resid(ED_lm_model), breaks = 20, col = "", main = "Histogram of Residuals", xlab = "Residuals", ylab = "Frequency")
